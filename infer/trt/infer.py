...
class TensorRTInfer:
    ...
    def infer(self, batch, top=1):
        ...
        h2d = (device_start - host_start)*1000
        d2h = (host_end - device_end)*1000
        latency = (device_end - device_start)*1000
        
        # print(f"Host to Device: {h2d} ms")
        # print(f"       latency: {latency} ms")
        # print(f"Device to Host: {d2h} ms")

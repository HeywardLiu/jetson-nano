...
class ImageBatcher:
    ...
    def __init__(self, input, shape, dtype, max_num_images=None, exact_batches=False, preprocessor="imagenet"):
        """
    ...
    def preprocess_image(self, image_path):
        ...
        * V1: The algorithm for EfficientNet V1, aka "Legacy", as defined in automl/efficientnetv2/preprocess_legacy.py.
        ...
        def imagenet_preprocess(image):
            ...
            img_nparray = transform(image).numpy()
            return img_nparray

...
#
"""
python3 eval_gt.py -i ~/mount-dir/.imagenet-val -a ~/mount-dir/.imagenet-val/imagenet-val-annotations.txt -e ~/mount-dir/models/trt-model/fp32/fp32-trims-deit-small-distill-3.1G-79.4.trt

nohup python3 eval_gt.py -i ~/mount-dir/.imagenet-val -a ~/mount-dir/.imagenet-val/imagenet-val-annotations.txt -e ~/mount-dir/models/trt-model/fp32/fp32-trims-deit-small-distill-3.1G-79.4.trt > acc-fp32-trims-deit-small-distill-3.1G.txt &
"""
import os
import sys
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument("-p", "--preprocessor", default="imagenet", choices=["V1", "V1MS", "V2", "imagenet"],
